...
type CommentAnswerButtonProps = {
    onClick: () => any
}

const CommentAnswerButton = ({ onClick }: CommentAnswerButtonProps) => {
    return (
        <div
            className="mt-[10px] flex cursor-pointer gap-[6px] py-[6px]"
            onClick={onClick}
        >
            <svg
            ...
            <p className="text-purple-accent text-[12px] select-none">
                უპასუხე
            </p>
        </div>
    )
...
export default CommentAnswerButton
